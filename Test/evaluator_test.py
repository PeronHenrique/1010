...
from Solver import count_near_complete_lines, flood_fill, get_regions

def test_count_near_complete_lines():
    board = Board(bits_from_string("""
        ...
        ..........
        """))
    assert count_near_complete_lines(board) == 2
    ...
    board = Board(bits_from_string("""
        ...
        ..........
        """))
    assert count_near_complete_lines(board) == 3
    ...
    board = Board(bits_from_string("""
        ...
        ..........
        """))
    assert count_near_complete_lines(board) == 5
    ...
    board = Board(bits_from_string("""
        ...
        ..........
        """))
    assert count_near_complete_lines(board) == 6
